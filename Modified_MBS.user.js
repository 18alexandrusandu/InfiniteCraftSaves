...
{
-webkit-animation: background-pan 3s linear infinite !important; animation: background-pan 3s linear infinite !important; background: linear-gradient(
to right,  rgb(45,255,196),
#167fc6,
#fefd62,
rgb(45,255,196)
) !important;
...
font-size: 16px !important; width: 200px !important;
...
.instance {
    border-color: rgb(45,255,196)!important;
}
...
.instance-discovered {
    ...
    -webkit-box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) rgba(var(--color-rgb), var(--opacity));
    -moz-box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) rgba(var(--color-rgb), var(--opacity));
    box-shadow: var(--x-offset) var(--y-offset) var(--radius) var(--spread) rgba(var(--color-rgb), var(--opacity));
    border-color: rgba(var(--color-rgb), 0.37) !important;
}
.item-discovered {
    --x-offset: 0px;
    --y-offset: 0px;
...
.instance-discovered-emoji {
   filter: brightness(0) saturate(100%) invert(100%) sepia(29%) saturate(5139%) hue-rotate(87deg) brightness(99%) contrast(97%) !important;}
...
`
    ...
    function changeColorsTofitEmoji()
     {
      var elements=document.getElementsByClassName(".instance");
       for(let elm of elements)
         {
            let emoji=elm.querySelectorAll('.instance-emoji');
            console.log(emoji);
